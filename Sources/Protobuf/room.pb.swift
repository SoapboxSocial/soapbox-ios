...
extension Event: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    6: .same(proto: "invitedAdmin"),
    7: .same(proto: "addedAdmin"),
    8: .same(proto: "removedAdmin"),
    9: .same(proto: "renamedRoom"),
    10: .same(proto: "recordedScreen"),
    11: .same(proto: "mutedByAdmin"),
  ]
